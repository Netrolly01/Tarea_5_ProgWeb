...
<form action="/eje5/resultado5.php" method="post" target="resultado">
    <div class="field">
        <label class="label">Nombre del Pokémon</label>
        <div class="control">
            <input class="input" type="text" placeholder="Escribe el nombre del Pokémon" name="pokemon" required />
        </div>
    </div>

    <div class="control">
        <button class="button is-primary">Obtener Información</button>
    </div>
</form>

<iframe name="resultado" style="width: 100%; height: 500px;"></iframe>
...
<script>
    window.onload = function () {
        ...
        page.style.background = "url('https://cdn.hobbyconsolas.com/sites/navi.axelspringer.es/public/media/image/2016/07/principal-pokemon.jpg?tf=3840x')";
