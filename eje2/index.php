...
<form action="/eje2/resultado2.php" method="post" target="resultado">
    <div class="field">
        <label class="label">Nombre</label>
        <div class="control">
            <input class="input" type="text" placeholder="Escriba el nombre de la persona" name="nombre" required />
        </div>
    </div>
